...
You have the opportunity to join the conversation and guide its direction, contributing your unique insights and perspectives within your {conversation.counter.remaining_interactions[agent.identity.name]} remaining interactions.
